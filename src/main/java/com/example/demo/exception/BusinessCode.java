...
public class BusinessCode {
    ...
    public static final ErrorResponse REFRESH_TOKEN_NOT_FOUND = new ErrorResponse("REFRESH_TOKEN_NOT_FOUND",
            "finding refresh token not found", HttpStatus.BAD_REQUEST);
}
